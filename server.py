            ...
            try:
                ...
                if attempt >= max_retries:
                    ...
                    raise HTTPException(
                        status_code=503,
                        detail=(
                            "ScholarAI is temporarily rate-limited by the Mistral Free tier. "
            ...
            try:
                ...
                if yielded_any:
                    ...
                    raise HTTPException(
                        status_code=503,
                        detail=(
                            "The Mistral service was rate-limited while generating the answer."
                        ),
                    )
    ...
    async def create_session_route(
        ...
        try:
            ...
            # Do not hide the real SQLite/database error behind
            # a generic "Failed to create session (500)".
            print(
