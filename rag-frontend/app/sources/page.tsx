...
export default function SourcesPage() {
  ...
  const [uploadingJobs, setUploadingJobs] =
    useState<UploadingJob[]>([]);
          ...
          <main className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar px-5 sm:px-10 py-8">
              ...
              <div className="max-w-5xl mx-auto">
                ...
                <h1 className="text-[26px] sm:text-[30px] font-bold text-violet-600 tracking-tight mb-2">
                  Knowledge Sources
                </h1>

                <p className="text-[14.5px] text-gray-500 mb-8">
                  Power up your ScholarAI by providing context through documents, images, URLs, or notes.
                </p>
                  ...
                  >
                    ...
                    <div className="w-14 h-14 rounded-2xl bg-[#E7E4FF]/15 flex items-center justify-center mb-4">
                      ...
                      <IconUpload
                        width={24}
                        height={24}
                        className="text-[#B4ADFF]"
                      />

                    </div>


                    <p className="text-[16px] font-bold text-gray-900 mb-1.5">
                      Upload Documents
                    </p>


                    <p className="text-[13px] text-gray-500 max-w-[260px] leading-relaxed">
                      Upload PDFs or images. ScholarAI will extract the text and add it to your knowledge base.
                    </p>
                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[11px] font-bold tracking-[0.1em] uppercase text-sky-400">
                          Web Context
                        </span>

                        <span className="text-[10px] font-semibold text-gray-500 ml-auto">
                          Coming soon
                        </span>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          disabled
                          className="shrink-0 px-4 py-2.5 rounded-xl bg-gray-100 text-gray-500 text-[13px] font-bold cursor-not-allowed"
                        >
                          Add
                        </button>
                    ...
                    <div
                      className={`${CARD} p-5 flex-1 flex flex-col opacity-50`}
                    >
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-[11px] font-bold tracking-[0.1em] uppercase text-rose-400">
                          Quick Notes
                        </span>
                      ...
                      <button
                        disabled
                        className="self-end px-4 py-2 rounded-xl border border-gray-200 text-gray-500 text-[12.5px] font-semibold cursor-not-allowed"
                      >
                        Import
                      </button>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`text-[11px] font-bold px-2.5 py-1 rounded-full ${LAVENDER_CHIP}`}
                    >
                      {sources.length}{" "}
                      {sources.length === 1
                        ? "ITEM"
                  ...
                  <div className="space-y-2 mb-3">
                    ...
                    {uploadingJobs.map(
                      (job) => (
                        ...
                        <div
                          key={job.id}
                          className="flex items-center gap-3.5 px-4 py-3.5 rounded-2xl bg-gray-50/60 border border-gray-200/80"
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[13.5px] font-medium text-gray-900 truncate m-0">
                              {job.name}
                            </p>
                          ...
                          <span
                            className={`shrink-0 text-[10px] font-bold tracking-wide px-2.5 py-1 rounded-full ${
                              job.status ===
                              "error"
                ...
                <div className="space-y-2">
                  ...
                  {loading && (
                    <p className="text-[13.5px] text-gray-500 py-6 text-center">
                      Loading sources…
                    </p>
                  )}
                  ...
                  {loadError &&
                    !loading && (
                      <p className="text-[13.5px] text-red-400 py-6 text-center">
                        {loadError}
                      </p>
                    )}
                    ...
                    (item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            className={`shrink-0 text-[10px] font-bold tracking-wide px-2.5 py-1 rounded-full ${NEUTRAL_BADGE}`}
                          >
                            {image
                              ? "OCR PROCESSED"
                              : "PROCESSED"}
