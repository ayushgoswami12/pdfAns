...
export default function SourcesPage() {
  ...
  const handleDelete = async (filename: string) => {
    ...
    setSources((prev) =>
      prev.filter((s) => s.filename !== filename)
    );
  ...
  const handleWipeAll = async () => {
    ...
    try {
      await Promise.all(
        previous.map((s) => deleteSource(s.filename))
      );
    } catch {
      await refresh();
    }
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar px-5 sm:px-10 py-8">
              <div className="max-w-5xl mx-auto">
                ...
                <p className="text-[14.5px] text-gray-500 mb-8">
                  Power up your ScholarAI by providing context through
                  ...
                  {sources.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[11.5px] text-gray-500 truncate m-0 mt-0.5">
                          PDF Document •{" "}
                          {formatFileSize(item.size_bytes)} • Uploaded{" "}
